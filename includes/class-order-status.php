...
if (!class_exists('order_status')) {
    class order_status {
        ...
        function display_order_status_list() {
            ...
            <h2 style="display:inline;"><?php echo __( '訂單狀態', 'textdomain' );?></h2>
            <fieldset>
