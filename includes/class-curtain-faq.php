...
if (!class_exists('curtain_faq')) {
    class curtain_faq {
        ...
        function display_curtain_faq_list() {
            ...
            <h2 style="display:inline;"><?php echo __( 'Q&A', 'textdomain' );?></h2>
            <fieldset>
                ...
                <table class="ui-widget" style="width:100%;">
                    <thead>
                        <tr>
                            <th><?php echo __( '#', 'textdomain' );?></th>
                            <th><?php echo __( 'Question', 'textdomain' );?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
